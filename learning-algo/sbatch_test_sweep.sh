#!/bin/bash
#SBATCH --job-name=bald_test
#SBATCH --partition=test
#SBATCH --cpus-per-task=8
#SBATCH --mem=16G
#SBATCH --time=00:15:00
#SBATCH --output=bald_test_%j.out
#SBATCH --error=bald_test_%j.err
# Smoke test: tiny config, fast partition, generous time cap.
...
# --- Activate Python environment (match sbatch_big_sweep.sh) -------------
module load python
